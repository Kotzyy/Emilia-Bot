...
const cekWaktuFam = (nino, _dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            nino.sendMessage(_dir[position].id, juwu, MessageType.text)
            _dir.splice(position, 1)
        }
    }, 1000)
}
